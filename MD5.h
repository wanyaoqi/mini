...
void convert(unsigned char *str, char *cdst)
{
	int i = 0; int j = 0;
	while (i<16)
	{
...
*/
    ...
    //MDString("hello world",digest); //直接输入字符串并得出结果   
    ...
    //第三种用法:   
/*
    MD5File("/home/wyq/Desktop/main.c",digest); //直接输入文件路径并得出结果    
